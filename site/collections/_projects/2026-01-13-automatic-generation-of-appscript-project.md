...
<div style="margin-left: 20px;">
  <img src="https://img.shields.io/badge/Google%20Apps%20Script-automation-blue?logo=google" alt="badge">
...
<ul style="margin-left: 80px;">
  <li>LLM-Optimized: Components designed as tools for language models</li>
  <li>Natural Language Processing: Convert plain English to Google Workspace actions</li>
  <li>Smart Prompt Engineering: Pre-configured templates for common automation scenarios</li>
  <li>Chainable Workflows: Connect components in flexible LangFlow pipelines</li>
</ul>
...
<div style="text-align: center; margin-top: 20px;">
  <img src="/images/lang.png" alt="LangFlow / language image" style="max-width: 100%; height: auto; border-radius: 8px;" />
</div>
